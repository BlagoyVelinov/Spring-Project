...
public class MovieControllerIT {
    ...
    private MovieViewDto mapMovieDtoToMovieView(CreateMovieDto createMovieDto) {
        ...
        return new MovieViewDto()
                .setId(1)
                .setName(createMovieDto.getName())
                .setMovieLength(createMovieDto.getMovieLength())
                .setHallNumber(createMovieDto.getHallNumber())
                .setAudio(createMovieDto.getAudio())
                .setSubtitles(createMovieDto.getSubtitles())
                .setDescription(createMovieDto.getDescription())
                .setImageUrl(createMovieDto.getImageUrl())
                .setTrailerUrl(createMovieDto.getTrailerUrl())
